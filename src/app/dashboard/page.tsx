...
export default function DashboardPage() {
  ...
  const hotOpportunities = opportunities.filter((o) => o.isHot);
  const otherOpportunities = opportunities.filter((o) => !o.isHot);
  const risingCount = opportunities.filter((o) => o.trend === "rising").length;
  const earned = 340;
  const goalPercent = Math.round((earned / earningsGoal) * 100);

  // Uber mode: find the top un-skipped opportunity
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-2 mb-2">
            ...
            <Badge variant="secondary" className="text-xs">
              Your bots found new opportunities
            </Badge>
          </div>
